...
if __name__ == '__main__':
    ...
    parser.add_argument('--src-path', type=str, default='/home/user/xinzhimeng/desk2/FOOD/baseline/basevoc_coco/model_0049999.pth', help='Path to the main checkpoint')
    parser.add_argument('--save-dir', type=str, default='/home/user/xinzhimeng/desk2/FOOD/baseline/r50/', help='Save directory')

...
yaml="/media/xzm2/a4a1dba5-468a-4b2e-9e30-47d18517ce18/food-2025/output/vis-1shot/config.yaml"

pth="/media/xzm2/a4a1dba5-468a-4b2e-9e30-47d18517ce18/food-2025/output/vis-1shot/model_final.pth"
...
def detect_objects(image_path,filename):
    ...
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.8  # 设置置信度阈值
   ...
   #exit()
    ...
    # 显示检测结果
    cv2.imwrite("/media/xzm2/a4a1dba5-468a-4b2e-9e30-47d18517ce18/food-2025/output/vis-res2/"+ filename, img_putlabel)

...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_hooks(self):
        ...
        def test_and_save_results():
            self._last_eval_results = self.test(self.cfg, self.model) # type: ignore
    ...
    def train(self):
        ...
        if hasattr(self, "_last_eval_results") and comm.is_main_process():
            verify_results(self.cfg, self._last_eval_results) # type: ignore
            return self._last_eval_results # type: ignore
    ...
    def build_train_loader(cls, cfg):
        ...
        """
        return build_detection_train_loader(cfg) # type: ignore
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        Overwrite it if you'd like a different data loader.
        """
        return build_detection_test_loader(cfg, dataset_name) # type: ignore

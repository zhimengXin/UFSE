...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, distributed, output_dir=None):
        ...
        json_file = PathManager.get_local_path(self._metadata.json_file) # type: ignore
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            self._predictions.append(prediction) # type: ignore
    ...
    def evaluate(self):
        ...
        if self._output_dir:
            ...
            with PathManager.open(file_path, "wb") as f:
                torch.save(self._predictions, f) # type: ignore

        self._results = OrderedDict()
        if "instances" in self._predictions[0]: # type: ignore
    ...
    def _eval_predictions(self):
        ...
        self._coco_results = list(
            itertools.chain(*[x["instances"] for x in self._predictions])) # type: ignore
        ...
        if self._output_dir:
            ...
            with PathManager.open(file_path, "w") as f:
                f.write(json.dumps(self._coco_results)) # type: ignore
                f.flush()
